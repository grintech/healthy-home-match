              ...
              <div className="row mt-3">
                ...
                <div className="col-lg-6 mb-4">
                  <div>
                    ...
                    <input type="text" className="form-control"  placeholder="https://www.linkedin.com/in/your-profile" />
                  </div>
                </div>
                <div className="col-lg-6 mb-4">
                  <div>
                    <label htmlFor="" className=" mb-2">Website Url</label>
                    <input type="text" className="form-control" placeholder="https://www.yourwebsite.com" />
                  </div>
                </div>
                <div className="d-flex justify-content-end">
                <Link class="btn ud-btn btn-white search_home_btn black_btn " data-discover="true" to="#">Update Social <i class="fas fa-arrow-right-long"></i></Link>
                </div>
              </div>
            </div>
